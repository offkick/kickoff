...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = -1448997634L;
    ...
    public final com.kickoff.domain.board.postcomment.QPostComment postComment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.postComment = inits.isInitialized("postComment") ? new com.kickoff.domain.board.postcomment.QPostComment(forProperty("postComment"), inits.get("postComment")) : null;
    }
