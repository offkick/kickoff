...
import com.kickoff.domain.soccer.team.league.*;
import com.kickoff.domain.soccer.team.league.game.LeagueGame;
import com.kickoff.domain.soccer.team.league.game.LeagueGameService;
import com.kickoff.domain.soccer.team.league.game.LeagueGameStatus;
import com.kickoff.domain.soccer.team.league.game.LeagueService;
        ...
        for (CompetitionTeamsResponse.Team team : competitionTeams.teams())
        {
            ...
            for (CompetitionTeamsResponse.Squad squad : team.squad())
            {
                Player player = Player.builder()
                        ...
                        .position(PlayerPosition.of(squad.position()))
    ...
    public void createCLSchedules()
    {
        ...
        for (MatchesFeignResponse.Match match : latestClMatch.matches())
        {
            ...
            Score score = Score.builder()
                    .awayScore(match.score().gameTime() != null ? match.score().gameTime().away() : null)
                    .homeScore(match.score().gameTime() != null ? match.score().gameTime().home() : null)
                    .build();
            ...
            leagueGameService.save(leagueGame);
        }
    }
}
